    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 31
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 31, $this->source); })()), "id", [], "any", false, false, false, 31), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Name</th>
...
";
    ...
    {
        return array (  140 => 44,  135 => 42,  130 => 40,  122 => 35,  115 => 31,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
", "category/show.html.twig", "/Users/hoangnhan/Documents/Reasearch Web/templates/category/show.html.twig");
    }
}
